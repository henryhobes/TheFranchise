...
```
wss://fantasydraft.espn.com/game-1/league-262233108/JOIN?1=1&2=262233108&3=2&4={REDACTED-MEMBER-GUID}&5=1:262233108:2:{REDACTED-MEMBER-GUID}:-2093442536&6=false&7=false&8=KONA&nocache=487371
```
...
SELECTED 2 4362238 3 {REDACTED-MEMBER-GUID}
```
...
```
AUTODRAFT 2 false
TOKEN 1:262233108:2:{REDACTED-MEMBER-GUID}:-2093442536
CLOCK 0 76305
AUTOSUGGEST 4262921
JOINED 2 {REDACTED-MEMBER-GUID}
SELECTING 2 30000
SELECTED 1 3918298 1 {D912C7E4-B61D-4E98-92C7-E4B61D9E983C}
SELECT 4362238
SELECTED 2 4362238 3 {REDACTED-MEMBER-GUID}
